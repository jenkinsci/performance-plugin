...
public class AbsoluteConstraint extends AbstractConstraint {
	...
	@Override
	public ConstraintEvaluation evaluate(List<? extends AbstractBuild<?, ?>> builds) throws InvocationTargetException, IllegalArgumentException, AbortException {
		if (builds.isEmpty()) {
			throw new IllegalArgumentException("Performance: No builds found to evaluate!");
		}
		checkForDefectiveParams(builds); // @Ivan: want to talk about this
	 ...
	 * 
	 * @param newValue
	 *            measured value of a specified metric of the newly created test
