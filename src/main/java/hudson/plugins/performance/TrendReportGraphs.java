...
public class TrendReportGraphs implements ModelObject
  ...
  public TrendReportGraphs(final AbstractProject<?, ?> project,final AbstractBuild<?, ?> build,
      final StaplerRequest request, String filename,
  ...
  public UriReport getUriReport(String uri) {
       if (performanceReport != null) {
           ...
           return build.getAction(PerformanceBuildAction.class).getPerformanceReportMap().getUriReport(uri);
       }
