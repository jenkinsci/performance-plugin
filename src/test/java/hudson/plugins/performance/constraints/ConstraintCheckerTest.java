...
import hudson.plugins.performance.constraints.PreviousResultsBlock;
...
public class ConstraintCheckerTest {
	...
	/**
	 * TestCase1
	 * HappyPath - Testing every combination of constraints against some builds
	...
	@Test
	public void happyPathForAbsoluteConstraints() throws SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, IOException, InterruptedException, ParseException, java.text.ParseException{
	...
	@Test
	public void happyPathForRelativeConstraints() throws SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, IOException, InterruptedException, ParseException, java.text.ParseException{
	...
	@Test
	public void happyPathForMixedConstraints() throws SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, IOException, InterruptedException, ParseException, java.text.ParseException{
	...
	public void setUp() {		
		...
		ac0 = new AbsoluteConstraint(Metric.AVERAGE, Operator.NOT_GREATER, "testResult0.xml", Escalation.INFORMATION,false, ob0, 100L);
		ac1 = new AbsoluteConstraint(Metric.ERRORPRC, Operator.NOT_GREATER, "testResult0.xml", Escalation.INFORMATION, false, ob1, 100L);
		ac2 = new AbsoluteConstraint(Metric.LINE90, Operator.NOT_GREATER, "testResult0.xml", Escalation.WARNING, false, ob0, 100L);
		ac3 = new AbsoluteConstraint(Metric.MAXIMUM, Operator.NOT_GREATER, "testResult1.xml", Escalation.WARNING, false, ob1, 100L);
		ac4 = new AbsoluteConstraint(Metric.MEDIAN, Operator.NOT_EQUAL, "testResult1.xml", Escalation.ERROR, false, ob2, 100L);
		ac4.setSpecifiedTestCase(false);
		ac5 = new AbsoluteConstraint(Metric.MINIMUM, Operator.NOT_LESS, "testResult1.xml", Escalation.ERROR, false, ob2, 100L);
		...
		rc0 = new RelativeConstraint(Metric.AVERAGE, Operator.NOT_GREATER, "testResult0.xml", Escalation.INFORMATION, false, ob0, rb0, 10);
		rc1 = new RelativeConstraint(Metric.ERRORPRC, Operator.NOT_GREATER, "testResult0.xml", Escalation.INFORMATION, false, ob1, rb1, 10);
		rc2 = new RelativeConstraint(Metric.LINE90, Operator.NOT_GREATER, "testResult0.xml", Escalation.WARNING, false, ob0, rb2, 10);
		rc3 = new RelativeConstraint(Metric.MAXIMUM, Operator.NOT_LESS, "testResult1.xml", Escalation.WARNING, false, ob1, rb3, 10);
		rc4 = new RelativeConstraint(Metric.MEDIAN, Operator.NOT_LESS, "testResult1.xml", Escalation.ERROR, false, ob2, rb4, 10);
		rc4.setSpecifiedTestCase(false);
		rc5 = new RelativeConstraint(Metric.MINIMUM, Operator.NOT_LESS, "testResult1.xml", Escalation.ERROR, false, ob2, rb5, 10);
